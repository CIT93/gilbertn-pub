...
displayOnPage(
  "Time I Start Doing Yoga or Exercise --->" + morningExerciseYogaStartTime
);
...
if (totalTimeSpentInClass >= 5) {
  ...
  let noTimeForBoth =
    "You have time to exercise or do Yoga and attend your class.";
}
...
if (classMondayTuesdayThursday) {
  ...
  schedule =
    schedule +
    " " +
    "Classes are 5 hours in total, exercising or doing Yoga takes me an hour";
